...
type Catalog struct {
	...
	// PublishedVersionsContext 是 PublishedVersions 的 context 感知版本。
	...
	// AllPublishedVersionsContext 是 AllPublishedVersions 的 context 感知版本。
	...
	// ArtifactByNameContext 是 ArtifactByName 的 context 感知版本。
	...
	// DependenciesForContext 是 DependenciesFor 的 context 感知版本。
