...
func newDependencyListResponse(deps []model.DependencyTarget) dependencyListResponse {
	return dependencyListResponse{Dependencies: deps}
}
...
func (s *Server) handleReplaceDependencies(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, newDependencyListResponse(deps))
}
